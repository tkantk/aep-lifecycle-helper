...
7. Run `npm test` before suggesting a change is done (use `npm test`, NOT
   ...
   enumerates `test/*.test.js`). **276 tests should pass** (as of the 2026-06-03
   day-label continuity session — /quota preflight retry, monitor poll backoff,
   opt-in job-detail namespace breakdown, redistributor day-label continuity).
